# Migration Guide — Deyin 2.0 (Reasonix Integration)

Upgrade from Deyin 0.x/1.x to **2.0.0** with the DeepSeek-Reasonix integration.
...
All toggles: **Settings → Reasonix integration**.
...
1. Disable all Reasonix feature flags in Settings.
...
- Integration status: [REASONIX_INTEGRATION_STATUS.md](./REASONIX_INTEGRATION_STATUS.md)
