...
| Purpose | URL | Source |
| --- | --- | --- |
| Remote config / feature flags | `https://cdn.deyin.dev/desktop/config/default.json` | `infra/cdn/desktop/config/default.json` |
| Update feed | `https://cdn.deyin.dev/desktop/releases` | electron-builder output |
...
# upload release/* (installers + *.yml manifests) to cdn.deyin.dev/desktop/releases/
```
