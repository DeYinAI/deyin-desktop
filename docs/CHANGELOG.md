...
### Major: DeepSeek-Reasonix integration
...
- New settings section: Reasonix integration (cache, coordinator, scheduler, evidence)
- What's New modal, Reasonix onboard flow, beta feedback form
...
- Privacy-respecting metrics in `reasonix-metrics.json`
