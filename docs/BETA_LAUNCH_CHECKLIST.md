...
- [ ] `pnpm --filter @deyin/agent-core test:reasonix` — full 174-test Reasonix suite green
...
- [ ] Discord `#reasonix-beta` channel ready and staffed
...
```bash
pnpm typecheck
pnpm --filter @deyin/agent-core test:reasonix
