/** Built-in free web search for web sessions: DuckDuckGo HTML endpoint, no API key.
 * Mirrors the desktop implementation; kept local so the server compiles in isolation. */
