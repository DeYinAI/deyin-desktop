...
import type { DeyinSettings, ModelInfo, ReasonixMetricsSnapshot } from "../../../shared/types.js";
...
export function CoordinatorSettings({ settings, liveModels, activeThreadId, onChange }: Props) {
  ...
  return (
    <div className="settings-page">
      ...
      <ReasonixDevTools threadId={activeThreadId} title="Coordinator decision log" />
    </div>
  );
}
