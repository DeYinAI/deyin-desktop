...
export const CH = {
  ...
  agentMetricsGet: "deyin:agent:metrics:get",
  agentMetricsReport: "deyin:agent:metrics:report",
  agentDiagnosticsGet: "deyin:agent:diagnostics:get",
  agentCacheClear: "deyin:agent:cache:clear",
...
export interface DeyinApi {
  ...
  agent: {
    metrics(): Promise<Advanced agentMetricsSnapshot>;
    weeklyReport(): Promise<Advanced agentWeeklyReport>;
    diagnostics(threadId?: string): Promise<Advanced agentDiagnostics>;
