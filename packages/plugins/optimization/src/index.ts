...
export type { OptimizationPluginConfig } from "./kernel-plugin.js";
...
export async function createOptimizationPlugin(opts: CreateOptimizationPluginOptions): Promise<OptimizationPlugin> {
  ...
  //   3. bundled alongside this module (packages/plugins/optimization/models/)
 ...
 * `../models` lands on `packages/plugins/optimization/models`. When bundled
